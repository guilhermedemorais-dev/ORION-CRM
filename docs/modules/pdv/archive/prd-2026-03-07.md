...
## Referência Visual
Mockup aprovado: `../../../design/mockups/pdv/overview.html`
...
Compare cada detalhe com `../../../design/mockups/pdv/overview.html` antes de mostrar.
⛔ Aguarde aprovação antes de continuar.
...
Compare visual com `../../../design/mockups/pdv/overview.html` antes de mostrar.
⛔ Aguarde aprovação antes de continuar.
