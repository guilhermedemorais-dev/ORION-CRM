...
// Os endpoints GET/PATCH /:id/stages/:stageId/defaults foram removidos na
// TASK-054: gravavam na tabela morta pipeline_stage_settings (dropada na
// migration 063). A config por etapa vive em flow_stage_rules (flows.routes.ts).
