...
import productCategoriesRoutes from './routes/product-categories.routes.js';
import roadmapRoutes from './routes/roadmap.routes.js';
import databaseAdminRoutes from './routes/database-admin.routes.js';
...
app.use('/api/v1/admin/database', databaseAdminRoutes);
