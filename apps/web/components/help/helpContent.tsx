    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { icon: <Package size={13} />,      label: 'Ação de estoque',       description: 'Por etapa: Reservar insumo, Baixar insumo reservado (fabricação), Baixar peça pronta ou Retornar ao estoque. Padrão: Nenhuma.' },
          { icon: <Lock size={13} />,         label: 'Quem pode mover',       description: 'Papel mínimo exigido para mover um pedido pra essa etapa. Ex.: só GERENTE/ADMIN movem pro Caixa. Padrão: qualquer papel.' },
